...
export default function NotFound() {
  ...
  return (
    <div className="w-full h-full">
      <div className="max-w-xl mt-[100px] m-auto px-4 xl:px-0 content-center py-[30px] md:py-[50px] lg:py-[70px]">
        <div
        ...
        <div className="w-full">
          <div className="max-w-[600px] text-center content-center text-[#04316B] text-[17px] sm:text-[16px] md:text-[19px] m-auto">
